...
{
    public Day05()
        : base(@"How About a Nice Game of Chess?", year: 2016, day: 5)
    {
    }
    ...
    public override object DetermineStepOneResult(FileReader reader)
    {
        ...
        for (var i = 0; i < int.MaxValue; i++)
        {
            ...
            {
                sb.Append(Convert.ToString(hash[2], toBase: 16));
    ...
    public override object DetermineStepTwoResult(FileReader reader)
    {
        ...
        for (var i = 0; i < int.MaxValue; i++)
        {
            ...
            if (isFirstFiveBitsZero)
            {
                ...
                {
                    var result = hash[3] >> 4;
                    password[index] = Convert.ToString(result, toBase: 16)[index: 0];
